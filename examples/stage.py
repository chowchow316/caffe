...
net = caffe.Classifier(caffe_root + 'models/BDGP_stage/deploy.prototxt',
                       caffe_root + 'models/BDGP_stage/BDGP_stage_iter_1000.caffemodel')
...
imgLst = open('/home/shuo/Documents/FlyExpress/BDGPInfo/full_labeled_data.txt', 'r').readlines()
n_Img = len(imgLst)
...
for i in xrange(n_Img):
	if i % 100 == 0: print i
	scores = net.predict([caffe.io.load_image(imgLst[i][:-1])])
...
np.savetxt('/home/shuo/Documents/FlyExpress/feat_fine_tune/BDGP_1000_5p.txt', feat5p, fmt = '%-8.4f')
...
np.savetxt('/home/shuo/Documents/FlyExpress/feat_fine_tune/BDGP_1000_7.txt', feat7, fmt = '%-8.4f')
