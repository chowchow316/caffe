...
imgLst = open('/home/shuo/Documents/FlyExpress/FlyFISHInfo/imageList.txt', 'r').readlines()
n_Img = len(imgLst)
...
for i in xrange(n_Img):
	if i % 10 == 0: print i
	scores = net.predict([caffe.io.load_image('/home/shuo/Documents/FlyExpress/images_FISH/' + imgLst[i][:-1])])
